...
const LandingPage = () => {
  ...
  return (
    <div className="overflow-x-hidden flex flex-col relative mx-auto items-center bg-white z-10">
      <header className=" p-3 recursive border-b border-b-primary w-[90%] text-center font-semibold text-3xl"> DZ Mouhami </header>
      <NavBar />
  ...
  return (
    ...
    >
      ...
      <motion.ul className="flex gap-[3rem] text-xl">
        <motion.li
          whileHover={{ scale: 1, originX: 0, color: "#1ABBED#1ABBED#D4AD6B" }}
          transition={{ type: "tween", duration: 0.2 }}
