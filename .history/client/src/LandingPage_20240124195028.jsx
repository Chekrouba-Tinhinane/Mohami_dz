...
import section1 from "./assets/landing/section1.jpg";import section1 from "./assets/landing/section1.jpg";
...
function Footer() {
  return (
    <footer
        id="contact"
        className="flex items-start justify-between w-screen px-24 py-10 "
      >
        <img src={} alt="" />
        {/* sixth section */}
