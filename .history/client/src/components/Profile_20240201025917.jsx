...
const Profile = ({ lawyers }) => {
  ...
  const navLinks = [
    { label: t("nav.about"), id: "about", offset: -50 },
    { label: t("nav.categories"), id: "categories", offset: 0 },
    { label: t("nav.reviews"), id: "reviews", offset: 50 },
    { label: t("nav.location"), id: "location", offset: -100 },
];
  return (
    <>
