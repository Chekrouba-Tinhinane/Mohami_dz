    ...
    <div className="flex space-x-2 items-center">
      <div className="flex items-center bg-primary ">
        ...
        >
          ...
          <MenuItem name="selectedFilter" value="Localisation">Localisation</MenuItem>
          <MenuItem name="selectedFilter" value="Spécialité">Spécialité</MenuItem>
          <MenuItem name="selectedFilter" value="Langue">Langue</MenuItem>
        </Select>
