...
import calendar from "../assets/appoint/calendar.svg"
...
function CalendarModal({ isOpen, onRequestClose }) {
  return (
    <Modal
      ...
      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 w-[500px] h-[400px]"
    ...
    >
      ...
      <div className=" flex border border-primary "> <img src={calendar} alt="" />  <div className=" flex flex-col"><small>DATE</small>  <p>Selectionner une date</p> </div>   </div>
