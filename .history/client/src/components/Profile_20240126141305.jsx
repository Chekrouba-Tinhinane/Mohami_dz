...
const Profile = () => {
  ...
  return (
    <div className=" flex flex-col items-center w-full  mx-4 py-8 px-12 bg-lightBrown min-h-max">
      <Coords />
...
function Avis({ profile }) {
  ...
  return (
    <div
      id="reviews"
      className=" w-[95%] my-[3rem] border-t-2 border-t-lightTypo opacity-70  pt-2 flex flex-col gap-3"
    >
