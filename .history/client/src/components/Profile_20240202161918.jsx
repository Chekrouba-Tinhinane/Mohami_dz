  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex h-full gap-5 items-center"
      >
        <div className={` ${showCalendar ? "basis-[40%]" : "basis-[60%]"} mr-10 flex flex-col justify-center place-self-start flex-shrink-0 transition-all duration-300`}>
        ...
        {showCalendar && (
        <div className={` ${showCalendar ? "basis-[60%]" : "basis-[40%]"} mr-10 flex flex-col justify-center place-self-start flex-shrink-0 transition-all duration-300`}>
