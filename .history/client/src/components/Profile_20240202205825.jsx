...
function CalendarModal({ lawyer, isOpen, onRequestClose }) {
  ...
  return (
    <Modal
      ...
      className={`transition-all duration-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 phone:max-tablet:h-[30px] phone:max-tablet:w-[260px] tablet:max-lg:w-[450px] tablet:max-lg:h-[320px] w-[640px] h-[436px]`}
