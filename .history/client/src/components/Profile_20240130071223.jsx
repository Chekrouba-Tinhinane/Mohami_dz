...
function CalendarModal({ lawyer, isOpen, onRequestClose }) {
  ...
  return (
    <Modal
      ...
      className={` absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 w-[700px] h-[436px]  ${showCalendar ? "gap-[1.5rem] scale" : ""}`} 
