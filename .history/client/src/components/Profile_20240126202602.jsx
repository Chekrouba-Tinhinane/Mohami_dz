...
function CalendarModal({ isOpen, onRequestClose }) {
  return (
    <Modal
      ...
      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 w-[300px] h-[400px]"
      overlayClassName="fixed top-0 left-0 right-0 bottom-0 bg-gray-900 bg-opacity-30 backdrop-blur-xs z-40     className="bg-white flex flex-col justify-around px-3 py-2 rounded-md"
      "
    >
