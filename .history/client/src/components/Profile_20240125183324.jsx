...
function Coords() {
  return (
    <div className="flex py-3 px-8">
      <div className=" basis-[70%] felx felx-col gap-4 ">
        <div className="flex flex-col gap-2"> <h2>William King</h2>
        <h4>Region, Ville, 11000</h4></div>
        <div className="flex ">
          ...
          <div className="flex flex-col">
            ...
            Rating here
            <p>
              Spécialité: Droits administratifs{" "}
