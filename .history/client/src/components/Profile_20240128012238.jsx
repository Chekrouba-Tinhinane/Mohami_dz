  ...
  return (
    ...
    >
      <div className="flex justify-between font-semibold tracking-wide text-lightTypo">
        Avis
        <GiveFeedBack lawyer={lawyer} onOpen={openModal} isOpen={isModalOpen} onSubmit={submitFeedback} onClose={closeModal} /> {/* Pass the necessary props */}
      </div>
...
const GiveFeedBack = ({ onOpen, isOpen, onSubmit, onClose, lawyer }) => {
  ...
  const handleSubmit = () => {
    ...
    console.log(userData?.userID, lawyer?.avocat.id , feedback, rating)
