  ...
  return (
    ...
    >
      {isMobile ? (
       ...
       <div
         className={` ${
           isMenuOpen ? "h-[90vh] w-[90vw] scale-100 opacity-100" : "h-0 w-0 scale-0 opacity-0"
         } w-full absolute z-50 shadow-md transform duration-300 top-5 -left-5 bg-red-200 transition-height transition-width transition-opacity transition-scale`}
       >
         Ham open
       </div>
     </div>
