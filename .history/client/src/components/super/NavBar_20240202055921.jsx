  ...
  return (
    ...
    >
      {isMobile ? (
       ...
       <div
         className={` ${
           isMenuOpen ? "h-[90vh] w-[90vw] opacity-100" : "h-0 w-[90vw] opacity-0"
         } w-full absolute z-50 shadow-md transition-height transition-opacity top-0 -left-5 bg-red-200`}
         style={{ transformOrigin: 'top' }} // Adjust transform origin to top
       >
         Ham open
       </div>
     </div>
