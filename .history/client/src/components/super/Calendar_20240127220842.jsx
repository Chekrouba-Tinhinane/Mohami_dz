...
import { useUserData } from "../../ClientSignIn";
...
export const Calendar = ({ avocat }) => {
  ...
  const handleBooking = async () => {
    ...
    const bookingData = {
      id_client: UserData.id, // Replace with the actual client ID
      id_avocat: 1, // Replace with the actual lawyer ID
      id_interval_libre: 2, // Replace with the actual free time slot ID
    };
