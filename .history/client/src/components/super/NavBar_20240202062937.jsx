    ...
    >
      {isMobile ? (
        <div className="relative w-screen flex">
          ...
          <div
            className={` ${
              isMenuOpen ? " opacity-95 max-h-screen w-screen" : "opacity-0 "
            } flex flex-col items-center w-full absolute z-10 shadow-md transition-height transfom duration-200 top-5 -left-0 bg-white py-3 px-3`}
          >
