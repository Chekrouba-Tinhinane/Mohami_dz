...
export const Calendar = ({ lawyer }) => {
  ...
  const handleTimeRowClick = (selectedTime) => {
    setActiveTime(selectedTime);    console.log(selectedTime, activeTime)
  ...
  const handleBooking = async (interval) => {
    ...
    const bookingData = {
      ...
      id_interval_libre: interval.id, // Replace with the actual free time slot ID
    };
