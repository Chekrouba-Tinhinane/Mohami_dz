...
const TimeSelection = ({ index, allTimes, activeTime, onClick, onCancel, onNext }) => (
  <motion.div
...
export const Calendar = ({ lawyer }) => {
  ...
  const handleBooking = async () => {
    ...
    const bookingData = {
      ...
      id_interval_libre: availabilityIntervals.id, // Replace with the actual free time slot ID
    };
