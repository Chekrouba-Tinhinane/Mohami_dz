...
function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="h-[320px] phone:max-lg:flex-col relative flex w-full justify-center mt-[10rem] text-white"
    >
      <img src={footer} alt="" className="w-full object-cover" />
      {/* sixth section */}
      <div className="absolute w-full pb-8 flex justify-center pt-[4rem]">
        <div className="flex items-center justify-between phone:max-lg:flex-col px-16 w-full">
