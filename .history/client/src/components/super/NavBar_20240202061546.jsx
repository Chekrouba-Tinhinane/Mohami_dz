      ...
      {isMobile ? (
        <div className="relative w-screen flex">
          ...
          <div
            ...
            } w-full absolute z-10 shadow-md transition-height transfom duration-200 top-5 -left-0 bg-white py-`}
          >
            <ul className=" flex flex-col items-center mx-auto text-left ">
