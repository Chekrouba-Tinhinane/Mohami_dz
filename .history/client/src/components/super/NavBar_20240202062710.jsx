      ...
      {isMobile ? (
        <div className="relative w-screen flex">
          ...
          <div
            ...
            } w-full absolute z-10 shadow-md transition-height transfom duration-200 top-5 -left-0 bg-white py-3 px-3`}
          >
              <ul className=" gap-4 flex flex-col w-full place-self-center justify-center justify-items-center  ">
                <ul className=" ">
