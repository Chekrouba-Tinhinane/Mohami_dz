...
export const Calendar = ({ onOpen, lawyer, onClose }) => {
              ...
              <div className="ml-4">
                {allTimes.length > 0 ? (
                  ...
                  <div className=" gap-3 flex flex-col items-center">
                    <div className=" font-semibold">No available slots for this date</div>
                    <p className=" text-primary cursor-pointer border border-primary px-4 py-2 rounded-sm" onClick={() => {onOpen(true) }}>Choisir une autre date</p>
                  </div>
                )}
              </div>
            ) : (
