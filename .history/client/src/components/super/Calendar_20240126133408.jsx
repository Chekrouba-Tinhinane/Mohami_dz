...
const TimeSelection = ({ allTimes, activeTime, onClick, onCancel, onNext }) => (
    <motion.div
      ...
      className="bg-white flex flex-col justify-around px-3 py-2 rounded-md -scroll-ml-3.5"
      style={{ scrollbarColor: "var(--primary) var(--primary)" }} // Customize scrollbar color
    >
