          ...
          <div className=" space-x-6">
            <div className="flex gap-[1rem]">
              <Link
                to={"/SignIn"}
                href=""
                className=" nav-item recursive flex items-center font-semibold text-primary border border-primary bg-white text-center text-lg py-1.5 px-3.5 hover:bg-opacity-70"
              >
                {t("connexion")}
              </Link>
              <div className="flex gap-[1rem]">
