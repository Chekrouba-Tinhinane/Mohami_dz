...
const TimeRow = ({ index, style, data, activeTime, onClick, availabilityIntervals }) => {
  const isActive = activeTime
    ? availabilityIntervals[index].getTime() === data[index].getTime() 
    : false;
...
const TimeSelection = ({ availabilityIntervals, allTimes, activeTime, onClick, onCancel, onNext }) => (
  <motion.div
  ...
  itemData={{
    times: allTimes,
    availabilityIntervals, // Pass availabilityIntervals here
    activeTime,
    onClick,
  }}
...
>
  {({ index, style }) => (
    <TimeRow
      ...
      style={style}
      data={allTimes}
      availabilityIntervals={availabilityIntervals} // Pass availabilityIntervals here as well
