  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (values.role === "Avocat") {
        ...
        postDate.id_speciality= values.id_speciality;
        postData.avocat.email=values.email;
        postData.avocat.password=values.password;
        postData.avocat.telephone=values.telephone;
      }
      else if (values.role === "Client") {
        postData.avocat.username=values.username;
        postData.avocat.email=values.email;
        postData.avocat.password=values.password;
        postData.avocat.telephone=values.telephone;
