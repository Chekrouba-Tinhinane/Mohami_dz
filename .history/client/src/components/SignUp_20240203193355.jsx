...
const SignupForm = ({ onCancel, onSubmit, specialities }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const postData = {
        // Common fields for both Avocat and Client
        email: values.email,
        password: values.password,
        telephone: values.telephone,
        // Additional fields specific to Avocat
        ...(values.role === "Avocat" && {
          avocat: {
        ...
        // Additional field specific to Client
        ...(values.role === "Client" && { username: values.username }),
      };
