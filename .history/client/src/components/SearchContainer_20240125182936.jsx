...
const SearchContainer = () => {
  ...
  return (
    <div className="flex flex-col gap-3 pb-4 w-full bg-lightBrown">
      <h3 className="place-self-start text-light text-opacity-65 font-semibold tracking-wide p-4">
        Recherche Avancée
      </h3>
      ...
      <button className="bg-primary text-white px-6 py-2 place-self-center" onClick={handleFilterClick}>
        Filtrer
      </button>
    </div>
  );
