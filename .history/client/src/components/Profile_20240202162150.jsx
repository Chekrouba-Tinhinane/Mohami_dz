...
function CalendarModal({ lawyer, isOpen, onRequestClose }) {
  ...
  return (
    <Modal
      ...
      className={`transition-all duration-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 w-[600px] h-[436px]`}
    ...
    >
      ...
      >
        <div className={` ${showCalendar ? "basis-[40%]" : "basis-[100%]"} mr-10 flex flex-col justify-center place-self-start flex-shrink-0 transition-all duration-300`}>
          ...
          <div className="flex border border-primary py-2 px-2 gap-3 cursor-pointer" onClick={handleToggleCalendar}>
        ...
        {showCalendar && (
        <div className={` ${showCalendar ? "basis-[60%]" : "basis-[40%]"}  transition-all duration-300`}>
        <Calendar onOpen={setShowCalendar} isOpen={showCalendar} lawyer={lawyer} onClose={onRequestClose} />
          </div>
        )}
      </motion.div>
    </Modal>
