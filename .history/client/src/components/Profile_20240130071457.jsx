...
function CalendarModal({ lawyer, isOpen, onRequestClose }) {
  ...
  return (
    <Modal
      ...
      overlayClassName={` ${showCalendar ? "gap-[1.5rem]" : " scale-0"}  fixed top-0 left-0 right-0 bottom-0 bg-gray-900 bg-opacity-50 backdrop-blur-xs z-40 `} 
    >
      <div className={`flex h-full ${showCalendar ? "gap-[1.5rem]" : ""}`}>
        <div
          className={`  ${
