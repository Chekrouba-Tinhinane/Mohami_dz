...
function About() {
  return (
    <div id="about" className=" w-[95%] gap-[2rem] flex flex-col border-t-2 border-t-lightTypo opacity-70  pt-2">
      <div className="w-[90%] ">
...
function Categories() {
  ...
  return (
    <div id="categories" className=" w-[95%] my-[3rem] border-t-2 border-t-lightTypo opacity-70  pt-2">
  ...
  return (
    <div className="p-4 flex flex-col gap-3">
      ...
      <span className="flex items-center gap-3">
        <h2 className="text-2xl text-gray-500">{profile?.rating}</h2>
        {/* Assuming Rating component is imported */}
        {/* <Rating className="" name="simple-controlled" value={profile?.rating} readOnly /> */}
      </span>
...
const lawyerComments = {
  "John Doe": [
    { user: "Alice", text: "John is an excellent lawyer. He helped me win my case."},
    { user: "Bob", text: "I highly recommend John. He is very professional and dedicated."},
    { user: "Charlie", text: "John provided me with great legal advice. I'm grateful for his help."}
  ],
  "Emily Smith": [
    { user: "David", text: "Emily is a fantastic lawyer. She guided me through a difficult legal process."},
    { user: "Emma", text: "I'm so thankful for Emily's expertise. She resolved my legal issue efficiently."},
    { user: "Frank", text: "Highly satisfied with Emily's services. She exceeded my expectations."}
  ],
