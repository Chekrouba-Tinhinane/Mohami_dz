            ...
            <Form className="space-y-4">
              <div className="flex space-x-">
                <div className="w-1/2">
                  ...
                  <Field type="text" name="nom" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
                ...
                <div className="w-1/2">
                  ...
                  <Field type="text" name="prenom" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
              ...
              <div>
                ...
                <Field type="password" name="confirmPassword" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
              ...
              <div className="flex space-x-4">
                <div className="w-1/3">
                  ...
                  <Field type="text" name="ville" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
                ...
                <div className="w-1/3">
                  ...
                  <Field type="text" name="region" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
                ...
                <div className="w-1/3">
                  ...
                  <Field type="text" name="codePostal" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
              ...
              <div>
                ...
                <Field type="tel" name="telephone" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
              ...
              <div>
                ...
                <Field type="text" name="siteWeb" className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
              ...
              <div className="flex justify-between">
                <button type="submit" disabled={isSubmitting} className="bg-yellow-500 text-white px-4 py-2 rounded">
                  S'inscrire
                </button>
                <button type="button" disabled={isSubmitting} onClick={() => {}} className="bg-yellow-500 text-white px-4 py-2 rounded">
                  Annuler
                </button>
              </div>
            </Form>
