  ...
  return (
    <div className="flex">
      ...
      <div className=" flex-col basis-[30%] border-l border-l-primary">
        <div className=" flex items "> <img src={msg} alt="" />Email :email_81194@gmail.com </div>
        <div className=" flex items "> <img src={phone} alt="" />Numéro de téléphone : 000-000-000 </div>
