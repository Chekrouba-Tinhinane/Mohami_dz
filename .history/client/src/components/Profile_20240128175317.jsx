      ...
      <div className="flex flex-col items-center mx-[4rem] my-4 py-8 px-12 bg-lightBrown min-h-max relative">
        ...
        {lawyer && (
          <>
            ...
            <Categories speciality={lawyer.speciality_name || lawyer.speciality.name} />
            <Avis lawyer={lawyer} />
  ...
  return (
    ...
    >
      <div className="w-[90%] flex flex-col gap-[2rem] tracking-wide ">
        <p>
          <strong>Nom: </strong> {lawyer.avocat?.first_name} {lawyer.avocat?.last_name}
        </p>
        <p>
        ...
        <p>
          <strong>Langue: </strong> {lawyer.avocatlangue}
        </p>
        <p>
