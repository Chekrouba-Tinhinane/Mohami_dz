...
const SignIn = () => {
  ...
  return (
    <div className="flex h-screen phone:max-lg:my-8">
      ...
      <div className="relative w-[30%] phone:max-lg:w-full phone:max-lg:mx-[5rem] phone:max-lg:my-[5rem] flex flex-col my-8 min-h-max pb-3 border border-primary mx-auto items-center">
