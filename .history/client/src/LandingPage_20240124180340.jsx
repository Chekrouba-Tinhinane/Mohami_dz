...
function Header() {
  return (
    <section id="" className=" relative flex w-screen justify-center my-3">
  ...
  return (
    ...
    >
      ...
      <div className=" basis-[40%] mb-16 ">
        ...
        <a href="" className=" py-2 px-5 text-white bg-primary hover:bg-opacity-65">
          Trouver un avocat
        </a>
      </div>
    </section>
...
function Feedback() {
  <section id="feedback" className=" relative flex w-screen justify-center my-3">
      <img src={section1} className="w-full h-[600px] object-cover" alt="" />
      <h2 className=" recursive absolute bottom-0 left-[10%] text-white w-[60%]">
        "Legal Solutions, Trusted Advocacy: Your Path to Justice Begins with
        Us."
      </h2>
