              ...
              <HomeLayout
                pageComponent={
                  <>
                    ...
                    >
                      Pick one : <span className="text-green-500 bg-green-300 p-2" onClick={() => setTest(true)}>1</span>{" "}
                      <span className="text-green-500 bg-green-300 p-2" onClick={() => setTest(false)}>2</span>
                    </div>
                    <div
                      onClick={() => {
                        toast.error((t) => (
