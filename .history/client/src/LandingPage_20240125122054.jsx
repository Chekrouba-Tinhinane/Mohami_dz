    ...
    <div className=" flex flex-col w-[80%] items-center mx-auto my-8 ">
      ...
      <div className="flex w-full justify-between ">
        <div className="flex flex-col items-center basis-[33%]">
          {" "}
          <h4 className=" recursive text-primary text-2xl">879+</h4>{" "}
          <span className=" w-[70%] text-center">Consultations</span>
        </div>
        <div className="flex flex-col items-center basis-[33%]">
          {" "}
          <h4 className=" recursive text-primary text-2xl">12 Mil</h4>{" "}
        ...
        <div className="flex flex-col items-center basis-[33%]">
          {" "}
          <h4 className=" recursive text-primary text-2xl">92%</h4>{" "}
          <span className=" w-[70%] text-center">
