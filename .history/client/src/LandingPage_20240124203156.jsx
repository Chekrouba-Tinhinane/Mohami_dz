...
function Header() {
  return (
    <section id="header" className=" relative flex w-screen justify-center my-3">
    ...
    <div className=" flex flex-col w-full items-center">
      ...
      <div className="flex justify-between">
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">879+</h4> <span className=" w-[70%]">Consultations</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">12 Mil</h4>{" "}
          <span className=" w-[70%]">Coûts recouvrés au bénéfice du client</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">92%</h4>{" "}
          <span className=" w-[70%]">Affaires pénales défendues avec succès</span>
        </div>
      </div>
    </div>
  );
  ...
  >
    ...
    <div className="absolute top-0 text-white">
      <div className=" flex flex-col items-center">
        ...
        <div className=" flex w-full bg-white  h-56 "> <div className=" flex flex-col "> <h2>Maria Imene</h2>  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>    <a href="" className=" recursive text-white bg-primary  p-4"> View Profile </a>  </div> </div>
