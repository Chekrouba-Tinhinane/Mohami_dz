 ...
 */}      <div className=" relative  w-[30%] flex flex-col h-[85%] pb-10  border border-primary mx-auto items-center">
        {/* right side */}
        <h1 className=" recursive text-primary absolute -top-10 bg-white">Se Connecter</h1>
        <header className=" text-center my-8">
          {/* Welcome */}
          <small className=" text-gray-500">Veuillez saisir vous informations.</small>
        </header>
        <form className=" basis-[60%] w-[65%]" action="">
          ...
          <div className="flex flex-col items-center gap-4  ">
            ...
            <a
              href=""
              className="  border border-primary recursive p- tracking-wider font-medium justify-center w-full flex gap-4 flex-shrink-0 min-w-max items-center"
            >
