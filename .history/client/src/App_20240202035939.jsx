...
const showToast = () => {
   testG ? toast.success('La modification a bien été enregistrée !') : toast.error("blabla error blabla")
}
  return (
              ...
              <HomeLayout
                pageComponent={
                  <>
                    ...
                    >
                        Pick one : <span onClick={() => setTest(true)}>1</span> <span onClick={() => setTest(false)}>2</span>
                    </div>
                    <div
                      onClick={() => {
                        toast.error((t) => (
