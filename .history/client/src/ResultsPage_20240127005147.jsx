...
const ResultsPage = ({ lawyers }) => {
  ...
  const handleSearch = (query) => {
    axios
      .get("http://192.168.1.127:8000/avocat/filtered-search", {keywords: query, Location: "imed", Speciality: "imed", Language: "french"}) // Adjust the URL according to your backend route
      .then((response) => {
