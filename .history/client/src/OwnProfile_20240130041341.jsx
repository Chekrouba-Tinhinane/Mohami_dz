        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex bg-white px-5 py-4 gap-4 justify-between rounded-md">
            <div className=" space-y-2 w-full">
              ...
              <p className=" text-sm text-gray-400">ImedBousakhria@gmail.com</p>
              <p className="flex items-center gap-1 font-semibold pb-3 border-b-2 border-b-primary">
                <span>
                  {" "}
                  <img src={phone} alt="" />{" "}
                </span>{" "}
              ...
              <p className="">
                <span className="font-bold gap-2 flex items-center">
                  {" "}
                  <img src={calendar} className=" w-4" alt="" /> Date de
                  rendez-vous:
                  <span className=" font-normal">30-01-2024</span>

                </span>
              </p>
              <p className=" flex items-center gap-2"> <img src={clock} className="w-4" alt="" /> <span className=" font-bold">Heure:</span> 08:00 AM - 09:00 AM</p>
            </div>
