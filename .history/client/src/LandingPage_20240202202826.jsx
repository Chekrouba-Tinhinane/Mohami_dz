...
function Feedback() {
  ...
  return (
    ...
    >
      <img
        src={section1}
        className="w-full h-[640px] phone:max-tablet:h-[1000px] bg-center object-cover"
        alt=""
      />
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center">
          <div className="flex items-center my-5 gap-4 phone:max-tablet:text-[0.6rem]">
          ...
          <div className=" flex gap-10 w-full px-[3rem] phone:max-tablet:flex-col phone:max-tablet:gap-3 phone:max-tablet:mx-[] ">
            {userComments.map((el, i) => {
              return (
                <div className=" flex flex-col justify-between bg-white p-6 rounded-md text-black text-sm min-h-fit ">
                  {el.comment}
...
function Achievements() {
  ...
  return (
    <div className=" flex flex-col items-center mx-auto my-10 gap-8 ">
