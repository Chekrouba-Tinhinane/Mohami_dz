...
const OwnProfile = ({ lawyer }) => {
  ...
  <div>
    <p><span className="font-bold">Name:</span> ImedBousakhria</p>
    <p><span className="font-bold">Email:</span> ImedBousakhria@gmail.com</p>
    <p><span className="font-bold">Phone:</span> 0557863631</p>
    <p><span className="font-bold">Date and Time:</span> 30-01-2024 <span>08:00 AM - 09:00 AM</span></p>
  </div>
