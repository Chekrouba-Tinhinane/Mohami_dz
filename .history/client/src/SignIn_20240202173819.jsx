...
const SignIn = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="relative w-[30%] phone:max-lg:w-full phone:max-lg:mx-[5rem] flex flex-col min-h-max pb-3 my-3 border border-primary mx-auto items-center">
        <h1 className="recursive text-primary absolute -top-8 phone:max-lg:-top-2   bg-white">
          {t("signIn")}
        </h1>
        ...
        >
          {({ errors, touched }) => (
            <Form className="basis-[60%] phone:max-lg:basis-[100%]">
