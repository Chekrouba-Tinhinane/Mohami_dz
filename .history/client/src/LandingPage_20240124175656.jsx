...
function About() {
  return (
    ...
    >
      {/* fifth section */}
      <div className="flex gap-[6rem] justify-center ite">
        <div className=" flex flex-col w-[40%]">
        <h2 className=" recursive w-[40%] place-self-end">A propos de DZ Mouhami</h2>
        <img src={hero} className="" alt="" /></div>
        <div className=" basis-[40%]">
          {" "}
          {/*  */}
          <h2 className=" tracking-wider w-[50%] my-4">DZ-Mouhami</h2>
