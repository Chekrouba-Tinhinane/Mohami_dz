...
const ResultsPage = ({ lawyers }) => {
  ...
  const handleSearch = (query) => {
    axios
      .get("http://192.168.1.127:8000/avocat/filtered-search", query) // Adjust the URL according to your backend route
      .then((response) => {
  ...
  const handleFilter = (filters) => {
    ...
    axios
      .post("http://192.168.1.127:8000/avocat/filtered-search", filters) // Adjust the URL according to your backend route
      .then((response) => {
