    ...
    >
      ...
      <div className="absolute w-full flex justify-center py-[4rem]">
        <div className="flex items-center justify-between px-16 max-w-[86rem] w-full">
          ...
          <div className="border-l border-l-white pl-10 flex flex-col gap-5 h-[90%] place-self-start">
            ...
            <div className="flex flex-col gap-2 font-light w-[80]"><p>Rue Cheikh Ammar, Béjaia, Algeria</p>
            <p>Tél 1-888-888-888</p></div>
