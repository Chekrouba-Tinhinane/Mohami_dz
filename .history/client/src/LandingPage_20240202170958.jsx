    ...
    >
      ...
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center">
          ...
          <div className=" flex gap-10 w-full px-[3rem] ">
...
function Hero() {
  ...
  return (
    <section id="hero" className=" relative flex w-screen justify-center my-8 ">
      <img
        src={section2}
        className="w-full min-h-fit bg-center object-cover"
        alt=""
      />
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center gap-[6rem]">
          ...
          <div className=" flex gap-8 w-[80%] bg-white text-black min-h-fit px-10 my-4 ">
