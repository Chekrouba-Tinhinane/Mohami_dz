...
function Feedback() {
  return (
    ...
    >
      ...
      <h2 className="relative text-white tracking-wider pl-2 pr-2">
      <span className="border-t-2 border-white absolute left-0 top-1/2 transform -translate-y-1/2 w-8"></span>
      Nos Témoignages
      <span className="border-t-2 border-white absolute right-0 top-1/2 transform -translate-y-1/2 w-8"></span>
    </h2>       </div>  
    </section>
  );
}
