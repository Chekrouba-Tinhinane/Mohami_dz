  ...
  return (
    <div className=" flex flex-col">
      ...
      <div className="flex w-[80%] justify-between">
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">879+</h4> <span className=" w-[]">Consultations</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">12 Mil</h4>{" "}
          <span className=" w-[]">Coûts recouvrés au bénéfice du client</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">92%</h4>{" "}
          <span className=" w-[]">Affaires pénales défendues avec succès</span>
        </div>
      </div>
    </div>
  );
