...
function Achievements() {
  return (
    <div className=" flex flex-col">
      ...
      <div className="flex w-[80%] justi">
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">879+</h4> <span>Consultations</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">12 Mil</h4>{" "}
          <span>Coûts recouvrés au bénéfice du client</span>
        </div>
        <div className="flex flex-col">
          {" "}
          <h4 className=" recursive">92%</h4>{" "}
          <span>Affaires pénales défendues avec succès</span>
        </div>
      </div>
    </div>
  );
