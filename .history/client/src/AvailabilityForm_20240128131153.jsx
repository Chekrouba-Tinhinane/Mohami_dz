    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12}>
        <form className="space-y-6" onSubmit={formik.handleSubmit}>
          <div><label htmlFor="DateInterval">Sélectionnez une date :</label>
          <TextField
            fullWidth
            id="DateInterval"
            name="DateInterval"
          ...
          <div><label htmlFor="HeureDebut">Heure de début :</label>
          <TextField
            fullWidth
            id="HeureDebut"
            name="HeureDebut"
          ...
          <div> <label htmlFor="HeureFin">Heure de fin :</label>
          <TextField
            fullWidth
            id="HeureFin"
            name="HeureFin"
