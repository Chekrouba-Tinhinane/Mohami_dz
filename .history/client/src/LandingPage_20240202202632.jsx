...
function Feedback() {
  ...
  return (
    ...
    >
      <img
        src={section1}
        className="w-full h-[640px] phone:max-tablet:h-[800px] bg-center object-cover"
        alt=""
      />
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center">
          ...
          <div className=" flex gap-10 w-full px-[3rem] phone:max-tablet:flex-col phone:max-tablet:flex-col ">
