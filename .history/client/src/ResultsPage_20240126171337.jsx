...
const ResultsPage = ({ lawyers }) => {
  ...
  const handleSearch = (query) => {
    /* fetch(`/search?q=${query}`) // Adjust the URL according to your backend route
      .then((response) => response.json())
      .then((data) => {
        setSearchResults(data); // Update search results state with data from the backend
  ...
  const handleFilter = (filters) => {
    ...
    axios.post("/filter", filters) // Adjust the URL according to your backend route
      .then((response) => {
