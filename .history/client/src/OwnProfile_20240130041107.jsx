          ...
          <div className="flex bg-white px-5 py-4 gap-4 justify-between rounded-md">
            <div className=" space-y-2 w-full"> 
              ...
              <p className="flex items-center gap-1 font-semibold pb-3 border-b-2 border-b-primary">
                <span> <img src={phone} alt="" /> </span> 0557863631
              </p>
              <p className="">
                <span className="font-bold gap-1 flex items-center">  <img src={calendar} className=" w-4" alt="" /> Date de rendez-vous:</span> 30-01-2024
              </p>
