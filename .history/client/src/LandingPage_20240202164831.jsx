...
function About() {
  ...
  return (
    <section
      ...
      className=" phone:max-lg:flex-col phone:max-lg:items-center mx-3 my-10 flex gap-[6rem] justify-center items-center"
    >
      <div className=" flex flex-col w-[40%] ">
        <h2 className=" recursive w-[40%] place-self-end">{t("aboutTitle")}</h2>
        <img src={hero} className="" alt="" />
      </div>

      <div className=" flex flex-col align-middle basis-[40%] mb-16 ">
