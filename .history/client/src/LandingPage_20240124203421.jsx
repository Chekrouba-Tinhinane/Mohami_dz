    ...
    <section id="hero" className=" relative flex w-screen justify-center my-4">
      ...
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center">
          ...
          <div className=" flex w-full bg-white text-black  h-56 px-10 ">
            <img src={maria} alt="" className=" basis-[30%] object-cover" />
            <div className=" flex flex-col basis-[70%] ">
              ...
              <a href="" className=" recursive text-white bg-primary  p-4">
                {" "}
                View Profile{" "}
              </a>{" "}
            </div>{" "}
