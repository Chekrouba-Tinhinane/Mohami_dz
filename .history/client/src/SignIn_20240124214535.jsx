...
const SignIn = () => {
  return (
    <div className=" flex h-screen items-center ">
      ...
      <div className="flex flex-col items-center justify-center min-w-max h-full">
      <div className=" relative  flex flex-col h-[85%] pb-10  border border-primary mx-auto items-center">
        {/* right side */}
