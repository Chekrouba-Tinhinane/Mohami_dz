    ...
    <section id="hero" className=" relative flex w-screen justify-center my-4">
      ...
      <div className="absolute top-0 text-white">
        <div className=" flex flex-col items-center">
          ...
          <div className=" flex gap-8 w-[80%] bg-white text-black h-[20rem] px-10 ">
            <img src={maria} alt="" className=" basis-[30%] object-contain" />
            <div className=" flex flex-col basis-[70%] ">
              {" "}
              <h2 className=" recursive ">Maria Imene</h2>{" "}
              <p className=" w-[70%]  ">
              ...
              <a href="" className="flex w-max recursive text-white bg-primary  p-4">
                View Profile
              </a>
            </div>
          </div>
