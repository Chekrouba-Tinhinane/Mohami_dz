...
function Feedback() {
  const userComments = [
    { username: "User123", comment: "Effortlessly found the right lawyer for my needs – the detailed profiles and client reviews streamlined the decision-making process." },
    { username: "LegalEagle", comment: "Incredibly user-friendly directory; comprehensive lawyer profiles and responsive design made my search for legal representation hassle-free." },
    { username: "LawSeeker", comment: "Highly impressed with the intuitive interface and wealth of information – this directory simplified the task of finding a skilled attorney." }
  ];
      ...
      <div className=" flex gap-10 w-[75%] ">

        {
            userComments.map((el, i) => {
              return <div className=" flex flex-col justify bg-white rounded-md text-black text-sm h-56 "> 
