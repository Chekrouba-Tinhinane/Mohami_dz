...
function Footer() {
  return (
    <footer
      id="footer"
      className="h-[300px] relative flex w-full justify-center items-center mt-[10rem] text-white"
    >
      <img src={footer} alt="" className="w-full object-cover" />
      {/* sixth section */}
      <div className="absolute w-[85%] flex justify-center">
        <div className="flex items-center justify-between px-16 max-w-6xl w-full">
          ...
          <div className="flex place-self-start gap-[]">
            <img src={twitter} alt="" />
            <img src={fb} alt="" />
