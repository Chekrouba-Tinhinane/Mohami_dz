...
function Feedback() {
  return (
    ...
    >
      ...
      <div className="flex items-center text-white gap-4"> <span>____________</span>        <h2 className=" recursive  tracking-wider ">Nos Témoignages</h2> <span>____________</span>
</div>
       </div>  
    </section>
  );
